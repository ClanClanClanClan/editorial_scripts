...
class SICONEmailTimelineAnalyzer:
    ...
    def _analyze_email_timeline(self, emails: list[dict], manuscript: dict) -> dict:
        ...
        timeline = {"invitations": [], "responses": [], "reminders": [], "reports": []}
    ...
    def _categorize_email(self, email: dict) -> str | None:
        ...
        if any(
            ...
            for term in ["invitation", "invite", "request to review"]
        ):
            return "invitations"
        elif any(
            term in subject or term in body for term in ["accepted", "declined", "agreed", "unable"]
        ):
            return "responses"
    ...
    def _extract_referee_from_email(self, email: dict) -> dict:
        ...
        return {"name": name, "email": referee_email}
    ...
    def _enhance_referee_data(self, manuscript: dict, timeline: dict) -> list[dict]:
        ...
        all_referees = manuscript.get("declined_referees", []) + manuscript.get(
            "accepted_referees", []
        )
        ...
        for referee in all_referees:
            ...
            if referee_emails.get("invitation") and referee_emails.get("response"):
                enhanced_ref["email_response_time"] = self._calculate_response_time(
                    referee_emails["invitation"]["date"], referee_emails["response"]["date"]
                )
    ...
    def _find_referee_emails(self, referee: dict, timeline: dict) -> dict:
        ...
        referee_emails = {"invitation": None, "response": None, "reminders": []}
    ...
    def _calculate_response_time(self, invitation_date: str, response_date: str) -> int | None:
