...
class CacheManager:
    ...
    def __init__(self, cache_dir: Path = None, test_mode: bool = None):
        ...
        if detected_test_env and not test_mode:
            print("🛡️ SAFETY OVERRIDE: Test environment detected, forcing test mode to prevent production pollution")
            test_mode = True
    ...
    def _is_test_environment(self) -> bool:
        ...
        try:
            ...
            try:
                ...
                while frame:
                    ...
                    if frame_filename != __file__:  # Skip our own file
                        ...
                        if ('/dev/' in frame_filename or 
                            'test' in frame_filename.lower() or
                            'editorial_scripts' in frame_filename):
            ...
            project_indicators = [
                ...
                str(Path(__file__).resolve()).endswith('editorial_scripts/production/src/core/cache_manager.py')
            ]
    ...
    def get_referee(self, email: str) -> Optional[CachedReferee]:
    ...
    def _save_referee(self, referee: CachedReferee):
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            data_hash = self._compute_data_hash(
                asdict(referee),
                ['name', 'institution', 'department', 'country', 'orcid']
            )
    ...
    def get_manuscript(self, manuscript_id: str, journal: str) -> Optional[CachedManuscript]:
    ...
    def should_update_manuscript(self, manuscript_id: str, journal: str, 
                                status: str = None, last_updated: str = None) -> bool:
    ...
    def get_institution_from_domain(self, domain: str) -> Optional[Tuple[str, str]]:
        ...
        with self.lock:
            ...
            with sqlite3.connect(self.db_path) as conn:
                cursor = conn.cursor()
                cursor.execute(
                    'SELECT institution_name, country FROM institutions WHERE domain = ?',
                    (domain,)
                )
                row = cursor.fetchone()
    ...
    def cache_referee_performance(self, referee_email: str, metrics: Dict[str, Any], 
    ...
    def get_referee_performance(self, referee_email: str) -> Optional[Dict[str, Any]]:
    ...
    def cache_journal_statistics(self, journal_id: str, period_start: str, period_end: str,
                                stats: Dict[str, Any]):
    ...
    def get_journal_statistics(self, journal_id: str, period_start: str = None,
    ...
    def get_cache_statistics(self) -> Dict[str, Any]:
        ...
        with sqlite3.connect(self.db_path) as conn:
            ...
            cursor.execute('SELECT COUNT(DISTINCT institution) FROM referees WHERE institution != ""')
            ...
            stats['recent_extractions'] = [
                {'journal': row[0], 'date': row[1], 'count': row[2]}
    ...
    def update_referee_performance_metrics(self, referee_email: str, metrics: Dict[str, Any], 
                                         valid_hours: int = 24):
    ...
    def get_referee_performance_metrics(self, referee_email: str) -> Optional[Dict[str, Any]]:
    ...
    def update_journal_statistics(self, journal_id: str, period_start: date, period_end: date,
                                total_submissions: int, average_review_time: float,
                                acceptance_rate: float, desk_rejection_rate: float):
    ...
    def get_journal_statistics(self, journal_id: str, period_start: date, 
                             period_end: date) -> Optional[Dict[str, Any]]:
...
class ExtractorCacheMixin:
    ...
    def should_extract_manuscript(self, manuscript_id: str, status: str = None, 
                                 last_updated: str = None) -> bool:
    ...
    def cache_manuscript_data(self, manuscript_data: Dict[str, Any]):
        ...
        cached = self.cache_manager.get_manuscript(
            manuscript_data['id'], self.journal_name
        )
    ...
    def get_cached_referee_data(self, email: str) -> Optional[Dict[str, Any]]:
    ...
    def finish_extraction(self, metadata: Dict[str, Any] = None):
        ...
        self.cache_manager.update_extraction_stats(
