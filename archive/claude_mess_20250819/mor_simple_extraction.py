...
def run_mor_extraction():
    ...
    try:
        ...
        category_links = driver.find_elements(
            By.XPATH, "//a[contains(@href, 'NEXT_PAGE=') and contains(text(), 'Awaiting')]"
        )
        ...
        for cat_link in category_links:
            ...
            take_actions = driver.find_elements(
                By.XPATH, "//img[contains(@src, 'check_off.gif')]/parent::a"
            )
                ...
                try:
                    ...
                    try:
                        referee_links = driver.find_elements(
                            By.XPATH,
                            "//a[contains(@onclick, 'popWindow') and contains(@onclick, 'referee')]",
                        )
