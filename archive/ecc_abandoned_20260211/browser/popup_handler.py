...
class PopupHandler:
    ...
    def extract_from_javascript_popup(self, popup_url: str) -> str | None:
        """
        ...
        try:
            ...
            logger.error("Popup extraction failed: %s", e)
    ...
    def _extract_popup_content(self) -> str | None:
        """
    ...
    def _extract_email_from_popup(self) -> str | None:
        """
    ...
    def _extract_review_content(self) -> dict[str, Any] | None:
        """
        ...
        try:
            ...
            for pattern in score_patterns:
                ...
                if match:
                    field_name = (
                        pattern.split(":")[0].lower().replace("\\s*", "").replace("(\\d+)", "")
                    )
    ...
    def _extract_abstract_content(self) -> str | None:
        """
    ...
    def _extract_generic_text(self) -> str | None:
        """
    ...
    def extract_referee_history_popup(self, popup_url: str) -> list[dict[str, Any]] | None:
        """
        ...
        try:
            ...
            for line in lines:
                ...
                if match:
                    ...
                    history.append({"date": date, "event": event})
    ...
    def extract_author_details_popup(self, popup_url: str) -> dict[str, Any] | None:
        """
