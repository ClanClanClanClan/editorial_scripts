            ...
            for category in categories:
                if category["count"] > 0:
                    ...
                    if take_action_links:
                        ...
                        try:
                            anchor = extractor.driver.find_element(
                                By.XPATH, "//a[.//img[contains(@src, 'lefttabs_mss_info')]]"
                            )
                            print(
                                f"\n   Method 1: Found anchor tag with href: {anchor.get_attribute('href')}"
                            )
                            print("   Clicking anchor...")
                            anchor.click()
                            time.sleep(3)
                        ...
                        try:
                            ...
                            clickable = extractor.driver.find_element(
                                By.XPATH,
