...
def summarize_current_state():
    ...
    maximum_extraction = {
        ...
        "popup_extracted": ["person_details", "review_comments", "editorial_notes"],
    ...
    print("   • Basic extraction with name-only 'affiliations'")
    print("   • ~20% of available MF website data")
    print()
    print(f"🔧 FIXED (Current): {fixed_extraction['total_fields_per_referee']} fields per referee")
    print("   • HTML parsing fix extracts real affiliations")
    print("   • Enhanced parsing separates institution + department")
    print("   • ~30% of available MF website data")
    print()
    print(
        f"🚀 MAXIMUM (Possible): {maximum_extraction['total_fields_per_referee']} fields per referee"
    )
    print("   • Popup extraction + online API enrichment")
    print("   • Complete review content + academic profiles")
    print("   • ~90% of available MF website data")

    expansion_factor = (
        maximum_extraction["total_fields_per_referee"]
        / current_extraction["total_fields_per_referee"]
    )
...
def calculate_data_richness_improvement():
    ...
    print("   From ~20% to ~90% of available MF website content")
