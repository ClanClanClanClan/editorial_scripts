            ...
            for category in categories:
                if category["count"] > 0:
                    ...
                    if take_action_links:
                        ...
                        try:
                            info_img = extractor.driver.find_element(
                                By.XPATH, "//img[contains(@src, 'lefttabs_mss_info')]"
                            )
                            ...
                            patterns = [
                                ...
                                (
                                    "Manuscript ID elements",
                                    "//td[contains(text(), 'Manuscript ID:')]",
                                ),
                                (
                                    "Submission Date elements",
                                    "//td[contains(text(), 'Submission Date:')]",
                                ),
                                (
                                    "Running Head elements",
                                    "//td[contains(text(), 'Running Head:')]",
                                ),
                                (
                                    "Article Type elements",
                                    "//td[contains(text(), 'Article Type:')]",
                                ),
                                (
                                    "Special Issue elements",
                                    "//td[contains(text(), 'Special Issue:')]",
                                ),
                            ...
                            info_tables = extractor.driver.find_elements(
                                By.XPATH,
