#!/usr/bin/env python3
"""Complete extraction test with 10 minute timeout showing all data."""

from mf_extractor import ComprehensiveMFExtractor
import json
from datetime import datetime

print('🚀 COMPLETE MF EXTRACTION WITH 10 MINUTE TIMEOUT')
print('=' * 70)
print('Starting extraction at:', datetime.now().strftime('%H:%M:%S'))
print()
...
try:
    ...
    if extractor.manuscripts:
        ...
        filename = f'mf_complete_extraction_{timestamp}.json'
