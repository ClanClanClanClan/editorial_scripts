            ...
            if device_code:
                ...
                try:
                    ...
                    submit_buttons = driver.find_elements(
                        By.XPATH,
                        "//input[@type='submit'] | //button[@type='submit'] | //a[contains(@class, 'btn')]",
                    )
                    visible_submits = [btn for btn in submit_buttons if btn.is_displayed()]

                    print(
                        f"   🔍 Found {len(visible_submits)} visible submit buttons after device verification"
                    )
                    ...
                    for btn in visible_submits[:3]:  # Check first 3
                        ...
                        if any(
                            ...
                            for word in ["continue", "submit", "proceed", "next"]
                        ):
