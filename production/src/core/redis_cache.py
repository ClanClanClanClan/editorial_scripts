...
class RedisCache:
    ...
    def __init__(self, redis_url: str = "redis://localhost:6379", prefix: str = "editorial_cache"):
        """
    ...
    def get_stats(self) -> dict[str, Any]:
        ...
        if not self.enabled:
            return {"status": "disabled", "reason": "Redis not available or connection failed"}
...
class APIResponseCache:
    ...
    def cache_api_response(
        self, endpoint: str, params: dict[str, Any], response: Any, ttl_seconds: int = None
    ):
        """
...
def create_redis_layer(redis_url: str = None) -> RedisCache | None:
