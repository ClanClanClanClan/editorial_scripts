...
class ExampleExtractor:
    ...
    def __init__(self):
        ...
        self.logger = setup_extraction_logging(
            ...
            log_file="example_extraction.log"
        )
            ...
            try:
                ...
                for j in range(manuscript_count):
                    ...
                    try:
                        ...
                        self.logger.extraction_success(
                            f"Extracted manuscript: {manuscript['id']}"
                        )
                    finally:
...
if __name__ == "__main__":
    print("🚀 CENTRALIZED LOGGING SYSTEM DEMO")
    print("="*60)
    ...
    print("Check 'example_extraction.log' for file output")