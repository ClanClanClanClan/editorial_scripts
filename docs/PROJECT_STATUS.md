...
**Last Updated: 2025-08-27 10:15 PDT**
**Session: Complete Documentation and Verification**
...
│   │   └── debug/                     # Debug files
│   └── fs/                            # FS development environment
├── config/
│   ├── gmail_token.json              # Gmail OAuth token (refreshed daily)
...
- **Status**: ✅ Token refreshed 2025-08-27 10:10 PDT
...
- **Current**: Login may fail due to site changes (needs monitoring)
...
4. **Gmail Token**: Refreshed 2025-08-27 10:10 PDT (valid for ~1 hour)

5. **MF Login Issues**: May need site-specific fixes if login fails
...
1. **Immediate**:
   ...
   - Fix MF login if site structure changed
   - Keep Gmail token refreshed
...
3. Load credentials: `source ~/.editorial_scripts/load_all_credentials.sh`
4. Verify credentials: `python3 verify_all_credentials.py`
5. Test FS: `cd production/src/extractors && python3 fs_extractor.py`
...
*This document represents the authoritative current state as of 2025-08-27 10:15 PDT*