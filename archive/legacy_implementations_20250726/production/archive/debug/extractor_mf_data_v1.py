...
def analyze_missed_opportunities_in_current_data():
    ...
    for manuscript in data:
        ...
        for referee in manuscript.get('referees', []):
            ...
            if ',' in affiliation and ('department' in affiliation.lower() or 'school' in affiliation.lower()):
                ...
                if len(parts) >= 2:
                    ...
                    print(f"   🏛️ {name}: Could parse '{affiliation}' into institution + department")
...
def analyze_html_structure_deeply():
    ...
    parsing_strategies = {
        ...
        "keyword_detection": {
            ...
            "detected": [kw for kw in ["University", "Department", "School", "College", "Institute"] 
...
def calculate_potential_data_expansion():
    ...
    potential_fields_per_referee = {
        ...
        "relationship": [
            "selection_rationale", "expertise_match_score", 
            "previous_reviews_for_journal", "workload_status"
        ]
    }
