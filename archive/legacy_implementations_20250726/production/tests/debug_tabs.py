                    ...
                    if take_action_links:
                        ...
                        for link in all_links:
                            ...
                            if (
                                ...
                                and len(text) > 3
                                and (
                                    "tab" in class_attr.lower()
                                    or "manuscript" in text.lower()
                                    or "information" in text.lower()
                                    or "audit" in text.lower()
                                    or "trail" in text.lower()
                        ...
                        for term in key_terms:
                            elements = extractor.driver.find_elements(
                                By.XPATH, f"//*[contains(text(), '{term}')]"
                            )
                            if elements:
