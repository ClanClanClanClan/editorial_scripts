...
class EmailAuditCrosschecker:
    ...
    def search_manuscript_emails(self, manuscript_id: str, referee_emails: List[str], 
                                date_range_days: int = 365) -> List[Dict]:
    ...
    def parse_email(self, message_id: str, manuscript_id: str, referee_emails: List[str]) -> Optional[Dict]:
        ...
        try:
            ...
            email_data['body_preview'] = body_text[:500] if body_text else email_data['body_snippet']
    ...
    def match_referee(self, from_email: str, to_email: str, referee_emails: List[str]) -> Optional[str]:
    ...
    def crosscheck_manuscript(self, manuscript_data: Dict) -> Dict:
        ...
        enhanced_timeline = self.create_enhanced_timeline(
            manuscript_data, email_communications
        )
    ...
    def create_enhanced_timeline(self, manuscript_data: Dict, email_communications: List[Dict]) -> List[Dict]:
        ...
        try:
            ...
            for i, manuscript in enumerate(manuscripts):
                ...
                try:
                    ...
                    print(f"⚠️ Failed to crosscheck manuscript {manuscript.get('id', 'Unknown')}: {e}")
