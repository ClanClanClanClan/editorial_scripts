    ...
    try:
        ...
        for idx, referee in enumerate(referees):
            ...
            if 'zhang' in name.lower() and 'panpan' in name.lower():
                ...
                print(f"      🚨 CRITICAL ISSUE: Zhang, Panpan found as referee!")
        ...
        for author in authors:
            if 'zhang' in author.get('name', '').lower() or 'panpan' in author.get('name', '').lower():
        ...
        print(f"   Expected: More specific referee table detection")
