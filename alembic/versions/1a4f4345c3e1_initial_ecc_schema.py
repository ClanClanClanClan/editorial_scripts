...
revision: str = "1a4f4345c3e1"  # pragma: allowlist secret - alembic revision id
...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_manuscripts_current_status"), "manuscripts", ["current_status"], unique=False
    )
    op.create_index(
        op.f("ix_manuscripts_external_id"), "manuscripts", ["external_id"], unique=False
    )
