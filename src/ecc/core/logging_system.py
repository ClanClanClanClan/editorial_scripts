...
class ExtractorLogger:
    ...
    def __init__(self, name: str = "extractor", log_file: Optional[str] = None):
        """
...
class LoggingContext:
    ...
    def __init__(self, logger: ExtractorLogger, operation_name: str, category: LogCategory = LogCategory.EXTRACTION):
        self.logger = logger
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        ...
        if exc_type is None:
            ...
            self.logger.error(f"Failed {self.operation_name} ({runtime:.1f}s): {exc_val}", self.category)
...
_default_logger: Optional[ExtractorLogger] = None
