...
def check_login_state():
    ...
    try:
        ...
        device_auth_elements = driver.find_elements(By.XPATH, "//h2[contains(text(), 'Device Authentication Required')]")
        ...
        manuscript_links = driver.find_elements(By.XPATH, "//a[contains(@href, 'manuscript') or contains(@href, 'MANUSCRIPT')]")
        if manuscript_links:
