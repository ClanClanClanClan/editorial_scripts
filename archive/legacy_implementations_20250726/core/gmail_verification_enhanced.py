...
def fetch_latest_verification_code(journal_code: str, max_wait: int = 60, poll_interval: int = 3, 
                                 start_timestamp: Optional[datetime] = None) -> Optional[str]:
    """
...
def _get_message_timestamp(message) -> Optional[datetime]:
...
def _extract_code_from_message(message) -> Optional[str]:
