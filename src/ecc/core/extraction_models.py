...
class RefereeTimeline:
    ...
    invitation_viewed: Optional[str] = None
    agreed_to_review: Optional[str] = None
    declined_date: Optional[str] = None
    review_submitted: Optional[str] = None
    review_modified: Optional[str] = None
    reminder_sent: List[str] = field(default_factory=list)
    total_days_to_review: Optional[int] = None
...
class Referee:
    ...
    status_details: Optional[RefereeStatusDetails] = None
    timeline: Optional[RefereeTimeline] = None
    ...
    def from_dict(cls, data: Dict[str, Any]) -> 'Referee':
        ...
        return cls(
            ...
            status_details=RefereeStatusDetails.from_dict(data['status_details']) if 'status_details' in data else None,
