...
class BrowserSession:
    ...
    def __init__(self, config: BrowserConfig | None = None, logger: logging.Logger | None = None):
        """
    ...
    async def _create_undetected_chrome(self) -> WebDriver:
        ...
        try:
            ...
            self.logger.warning(
                "undetected_chromedriver not available, falling back to regular Chrome"
            )
...
async def browser_session(
    config: BrowserConfig | None = None, logger: logging.Logger | None = None
):
    """
