...
class CredentialManager:
    ...
    def _get_from_keychain(self, journal_code: str) -> dict[str, str] | None:
            ...
            try:
                result = subprocess.run(
                    [
                        ...
                        "editorial-scripts",
                        "-a",
                        f"editorial-scripts-{journal_code.lower()}-email",
                        "-w",
                    ],
                    capture_output=True,
                    text=True,
            ...
            try:
                result = subprocess.run(
                    [
                        ...
                        "editorial-scripts",
                        "-a",
                        f"editorial-scripts-{journal_code.lower()}-password",
                        "-w",
                    ],
                    capture_output=True,
                    text=True,
    ...
    def _get_from_env(self, journal_code: str) -> dict[str, str] | None:
    ...
    def _get_from_config(self, journal_code: str) -> dict[str, str] | None:
    ...
    def store_credentials(self, journal_code: str, email: str, password: str) -> bool:
        ...
        try:
            ...
            keyring.set_password(
                self.SERVICE_NAME, f"{journal_code.upper()}_CREDENTIALS", json.dumps(credentials)
            )
    ...
    def _get_journal_platform(self, journal_code: str) -> str | None:
