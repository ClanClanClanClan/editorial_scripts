...
def test_robustness_improvements():
    ...
    try:
        ...
        if results:
            ...
            for manuscript in results:
                ...
                if conflicts_found == 0:
                    print(f"   ✅ No author/referee conflicts detected")
        ...
        test_results = {
            ...
            'conflicts_detected': sum(1 for m in results for r in m.get('referees', []) if r.get('conflict_with_authors')) if results else 0
        }
