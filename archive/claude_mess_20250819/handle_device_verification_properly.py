    ...
    try:
        ...
        if "twoFactorAuthForm" in page_source:
            ...
            if modal.is_displayed():
                ...
                print(
                    f"🕒 Device verification timestamp: {device_timestamp.strftime('%H:%M:%S.%f')}"
                )
                ...
                device_code = fetch_latest_verification_code(
                    "MOR", max_wait=30, poll_interval=3, start_timestamp=device_timestamp
                )
                    ...
                    try:
                        ...
                        if "logged out" in final_page.lower() or "inactivity" in final_page.lower():
                            ...
                            if "Associate Editor" in nav_page:
                                ...
                                print("\n🎉 COMPLETE SUCCESS!")
                                print("✅ Device verification handled properly")
                                print("✅ Navigation successful")
                                print(f"✅ Found {len(manuscripts)} manuscripts")
                                print("💾 Success saved to device_verification_success.json")
