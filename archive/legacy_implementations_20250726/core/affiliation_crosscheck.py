...
class AffiliationCrossChecker:
    ...
    def get_affiliation_from_orcid(self, orcid_url: str) -> dict[str, Any] | None:
                ...
                for group in data.get("employment-summary", []):
                    ...
                    if summaries:
                        ...
                        if disambiguated.get("disambiguated-organization-identifier"):
                            result["external_id"] = disambiguated[
    ...
    def infer_institution_from_email(self, email: str) -> str | None:
    ...
    def search_semantic_scholar(self, name: str, email: str = None) -> dict[str, Any] | None:
    ...
    def get_ror_id(self, institution_name: str) -> str | None:
